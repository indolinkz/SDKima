// Based on Google Ads IMA SDK HTML5 Advanced Samples v2.4
// Source: https://github.com/googleads/googleads-ima-html5/releases
...
Ads.prototype.onAdsManagerLoaded_ = function(adsManagerLoadedEvent) {
  ...
  adsRenderingSettings.mimeTypes = ['application/x-mpegURL', 'video/mp4', 'video/mpeg', 'video/ogg',
'video/3gpp', 'video/webm', 'application/dash+xml'];
...
var Application = function() {
  ...
  this.sampleAdTag_ = document.getElementById("samplevideotags");
  this.sampleAdTag_.addEventListener(
    "change",
    this.bind_(this, this.onSampleAdTagSelected_),
    false
  );
  for (var i = 0; i < this.SAMPLE_AD_TAGS_.length; i++) {
    var option = document.createElement("option");
    option.text = this.SAMPLE_AD_TAGS_[i].name;
    option.value = this.SAMPLE_AD_TAGS_[i].tag;
    this.sampleAdTag_.add(option);
  }
  ...
  this.requestAdsButton_ = document.getElementById("requestads");
  this.requestAdsButton_.addEventListener(
    "click",
    this.bind_(this, this.onRequestAdsClick_),
    false
  );
...
Application.prototype.SAMPLE_AD_TAGS_ =
  [
  tag = {
  ...
  tag:"https://pubads.g.doubleclick.net/gampad/ads?sz=640x480&iu=/124319096/external/single_ad_samples&ciu_szs=300x250&impl=s&gdfp_req=1&env=vp&output=vast&unviewed_position_start=1&cust_params=deployment%3Ddevsite%26sample_ct%3Dredirecterror&correlator="},
  tag = {
  name:"Single Non-linear Inline",
  ...
  tag = {
  name:"VMAP Post-roll",
  tag:"https://pubads.g.doubleclick.net/gampad/ads?sz=640x480&iu=/124319096/external/ad_rule_samples&ciu_szs=300x250&ad_rule=1&impl=s&gdfp_req=1&env=vp&output=vmap&unviewed_position_start=1&cust_params=deployment%3Ddevsite%26sample_ar%3Dpostonly&cmsid=496&vid=short_onecue&correlator="},
  tag = {
  ...
  tag:"https://pubads.g.doubleclick.net/gampad/ads?sz=640x480&iu=/124319096/external/ad_rule_samples&ciu_szs=300x250&ad_rule=1&impl=s&gdfp_req=1&env=vp&output=vmap&unviewed_position_start=1&cust_params=deployment%3Ddevsite%26sample_ar%3Dpremidpostoptimizedpod&cmsid=496&vid=short_onecue&correlator="},
  tag = {
  name:"AdX Standard InStream (non-skippable linear ads)",
  tag:"http://googleads.g.doubleclick.net/pagead/ads?ad_type=standardvideo&client=ca-video-pub-4968145218643279&videoad_start_delay=0&description_url=http%3A%2F%2Fwww.google.com&hl=en&max_ad_duration=60000&adtest=on"},
  tag = {
  name:"AdX TrueView InStream (skippable linear ads)",
  tag:"http://googleads.g.doubleclick.net/pagead/ads?ad_type=skippablevideo&client=ca-video-pub-4968145218643279&videoad_start_delay=0&description_url=http%3A%2F%2Fwww.google.com&hl=en&max_ad_duration=60000&adtest=on"},
  tag = {
  name:"AdX Bottom-third Overlays (non-linear)",
  tag:"http://googleads.g.doubleclick.net/pagead/ads?ad_type=text_image_flash&client=ca-video-pub-4968145218643279&videoad_start_delay=0&description_url=http%3A%2F%2Fwww.google.com&hl=en&max_ad_duration=60000&adtest=on&overlay=1"}
];
...
Application.prototype.onSampleAdTagSelected_ = function() {
  this.adTagBox_.value = this.sampleAdTag_.value;
};
...
Application.prototype.onRequestAdsClick_ = function() {
